...
export const studentEvents = new StudentEventEmitter();
...
export class Student {
  ...
  static updateStudent(id, name, age, group) {
    const studentIndex = Student.students.findIndex(
      (student) => student.id === id
    );
    if (studentIndex === -1) {
      return null;
    ...
    studentEvents.emit('student:updated', {
      student,
      totalStudents: Student.students.length,
    });
    return student;
